...
# =============================================================================
# [Loss Function] - ±60° 회전 강건성 최적화 (GTX 1660 SUPER 6GB)
# =============================================================================

# [Geometric Accuracy] - 회전 평면 일관성 강조
LAMBDA_SCALAR = 1.0              # ✅ 기준값 (변경 불필요)
LAMBDA_VECTOR = 15.0             # ⬇️ 50 → 15 (방향 과적합 방지, 회전에 덜 민감)
LAMBDA_BIVECTOR = 2500.0         # ⬆️⬆️ 1000 → 2500 (회전 평면 안정성 극대화)

# [Final Consistency] - 각도 직접 비교 + 행렬 안정성
BETA_COORD = 1.5                 # ⬇️ 10 → 1.5 (모서리 과최적화 방지)
LAMBDA_ANGLE = 1800.0            # ⬆️ 2000 → 1800 (각도 압박 유지하되 약간 완화)
LAMBDA_PIXEL = 0.4               # ⬆️ 0.05 → 0.4 (픽셀 복원력 강화)
LAMBDA_ROTATION_INV = 2200.0     # ⬆️⬆️ 800 → 2200 (행렬 직교성 극대화)

# [SmoothL1 Beta]
SMOOTH_L1_BETA = 1.2             # ⬇️ 2.0 → 1.2 (큰 오차에 더 강하게 반응)

# [Iterative Stability]
GAMMA_CONVERGENCE = 0.35         # ⬇️ 0.5 → 0.35 (수렴 압박 완화)
GAMMA_MULTISCALE = 0.2           # ⬇️ 0.3 → 0.2 (다중스케일 부담 감소)
