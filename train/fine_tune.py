...
BATCH_SIZE = 1                   # [Hyperparameter] RTX 3090: 2 → 8 (4배 증가)
ACCUM_STEPS = 8                  # [Hyperparameter] Gradient Accumulation (effective batch = 32)
NUM_EPOCHS = 360                 # [Hyperparameter] 총 학습 에폭 수 (±180° 커리큘럼)
LEARNING_RATE = 1e-4             # [Hyperparameter] 초기 학습률 (더 안정적)
